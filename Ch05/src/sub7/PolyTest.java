 ...
 * 
 * 다형성(Polymorphism)
 *  - 상속관계에서 부모클래스의 기능이 자식 클래스에서 다양한 기능으로 변하는 특성
...
public class PolyTest {
	...
	public static void main(String[] args) {
		...
		// 다운캐스팅 // 업캐스팅은 부모클래스에서 발생, 다운캐스팅은 자식클래스에서 발생?
		...
		// 객체 타입 비교연산
		if(a1 instanceof Tiger) { // instanceof 는 객체타입확인연산, a1객체 타입이 Tiger 이면
			System.out.println("a1은 Tiger 입니다.");
			
		}else if(a1 instanceof Eagle) { // a1객체 타입이 Eagle이면
